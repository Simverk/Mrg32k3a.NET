...
/// initial state, the start of its current substream, its current state, and its two output flags.
/// </summary>
/// <remarks>
/// <para>
...
/// rejects a version it does not understand rather than guessing.
/// </para>
/// </remarks>
